...
import { GUARDIAN_END_POINT, CITY_END_POINT, CLASS_END_POINT, LOCATION_END_POINT } from '@/constants';
...
const StudentForm = ({ isOpen, onClose, setEditData, isParentRender }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (setEditData?._id) {
                const update = await put(GUARDIAN_END_POINT.update(setEditData._id), teacherInfo);
                ...
                const response = await post(GUARDIAN_END_POINT.create(), teacherInfo);
