...
const TutorRequestForm = () => {
  ...
  const [error, setError] = useState({
    ...
    noOfStudent: "No of student require",
    subject: "Please select subject",
    class: "Please Select Class",
    city: "Please select City",
    location: "Please select Location",
    address: "Please Write Address",
    studentGender: "Please Select student Gender",
    teacherGender: "Please select Teacher Gender",
    daysPerWeek: "Days Per Week Require",
    preferenceInstitute: "Preference Institude is require",
    salaryType: "Please Select Salary",
    salary: "Salary is mandatory",
    phone: "Phone number is required",
    isApproval: "",
    tuitionType: "Select tution type",
...
console.log(defaultPhoneNumber)
  ...
  const { data: categoryList, refetch: fetchTotalCategory } = useGetAllData(
  ...
  /**fetch subject list */
  const { data: subjectList, refetch: fetchSubjectList } = useGetAllData(
  ...
  /** Fetch city */
  const { data: cityList, refetch: fetchCityList } = useGetAllData(
  ...
  /**city dropdown */
  useEffect(() => {
    const CITYDROPDOWN = mapArrayToDropdown(cityList?.data, "name", "_id");
  ...
  const handleChange = (e, selectedOptions) => {
    ...
    if (
      name === "status" ||
      (name === "isApproval" && e.target.type === "select-one")
    ) {
      // Handle select input
      setJobCreation((prev) => ({
        ...prev,
      ...
      setJobCreation((prev) => ({
        ...prev,
        [name]:
          name === "noOfStudent" || name === "daysPerWeek"
            ? parseInt(value, 10)
            : value,
      }));
    } else if (name === "class") {
                  ...
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        ...
                        defaultValue={tokenValues?.phone}
                      />
                      ...
                      <div className="flex space-x-4">
                        <label className="inline-flex items-center">
                          <input
                            ...
                            defaultChecked={
                              jobCreation?.studentGender === "Male"
                            }
                          />
                        ...
                        <label className="inline-flex items-center">
                          <input
                            ...
                            className="form-radio h-5 w-5 text-primary border-primary focus:ring-0 focus:outline-none"
                            defaultChecked={
                              jobCreation?.studentGender === "Female"
                            }
                          />
                        ...
                        {numOfStudent > 1 && (
                          <label className="inline-flex items-center">
                            <input
                              ...
                              className="form-radio h-5 w-5 text-primary border-primary focus:ring-0 focus:outline-none"
                              defaultChecked={
                                jobCreation?.studentGender === "Both"
                              }
                            />
                      ...
                      <div className="flex space-x-4">
                        <label className="inline-flex items-center">
                          <input
                            ...
                            className="form-radio h-5 w-5 text-primary border-primary focus:ring-0 focus:outline-none"
                            defaultChecked={
                              jobCreation?.teacherGender === "Male"
                            }
                          />
                          <span className="ml-2">Male</span>
                        </label>
                        ...
                        <label className="inline-flex items-center">
                          <input
                            ...
                            className="form-radio h-5 w-5 text-primary border-primary focus:ring-0 focus:outline-none"
                            defaultChecked={
                              jobCreation?.teacherGender === "Female"
                            }
                          />
                          <span className="ml-2">Female</span>
                        </label>
