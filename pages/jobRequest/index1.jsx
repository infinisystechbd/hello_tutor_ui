...
const JobRequestDetails = () => {
    ...
    const actionButton = (row) => {
        ...
        return <>
            ...
            <Link href={{ pathname: '/jobRequest/form/TutorRequestFrom1', setEditData: { row } }}>
                <a style={{ color: 'green', marginRight: '10px' }}>
                    <EyeOutlined style={{ fontSize: '24px' }} />
                </a>
                </Link>
                <Link href={`/jobRequest/update/${row._id}`}>
                <a className="text-primary" style={{ marginRight: '10px' }}>
                                ...
                                <div className=" ">
                                    <div className="d-flex border-bottom title-part-padding align-items-center">
                                        ...
                                        <div className="ms-auto flex-shrink-0">
                                            <div className="ms-auto flex-shrink-0">
                                                <Link href={{ pathname: '/jobRequest/form/TutorRequestFrom1'}}>
