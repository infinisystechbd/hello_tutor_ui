...
const SignUpFirstComponent = ({ otpSent, setPostEmailOtp, postEmailOtp }) => {
    ...
    const checkboxData = [
        { id: 'teacher', name: "Teacher", src: 'https://cdn0.iconfinder.com/data/icons/tutor-icon-set/512/teacher_writing_on_board-512.png' },
        { id: 'student', name: "Student", src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5sChniPpNGCn0KsJ1Ps7atiaB0Lg8C0BWXOk7qeUtqg&s' },
    ];

    return (
        <>
            <div className="mb-5.5 flex flex-col gap-5.5 md:flex-row sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2  " key={checkbox.id}>
                        ...
                        >
                            ...
                            <div style={{ position: 'absolute', top: '50%', right: 0, transform: 'translateY(-50%)' }}>
                                <p style={{ margin: '70px', fontSize: '1.2rem', fontWeight: 'bold', color: 'black' }}>{checkbox?.name}</p>
                            </div>
                        </label>
