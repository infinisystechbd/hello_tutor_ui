export const DASHBOARD_END_POINT = {
    ...
    dashbord: (status,limit,page,fromDate='',toDate='') => `/job/dashboard?status=${status}&sortBy=updatedAt&orderBy=desc&limit=${limit}&page=${page}&fromDate=${fromDate}&toDate=${toDate}`,
