export const DASHBOARD_END_POINT = {
    ...
    dashbord: (status,limit,page,fromDate='',toDate='',tuitionType='',city='',location='',category='',Class='',subject='') => `/job/dashboard?status=${status}&sortBy=updatedAt&orderBy=desc&limit=${limit}&page=${page}&fromDate=${fromDate}&toDate=${toDate}&tuitionType=${tuitionType}&city=${city}&location=${location}&category=${category}&class=${Class}&subject=${subject}`,
